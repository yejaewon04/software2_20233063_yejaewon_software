...
#define _DUTY_MAX 2050 // 2050
#define _DUTY_NEU 1500 // 1500
#define _DUTY_MIN 950 // 950

#define _SERVO_ANGLE_DIFF  100  // Replace with |D - E| degree
#define _SERVO_SPEED       1200  // servo speed
...
float volt_to_distance(int a_value)
{
  ...
  return 769 + (-3.81*a_value) + (6.79*pow(10,-3)*a_value*a_value) + (-4.26*pow(10,-6)*a_value*a_value*a_value);
}
